...
const { songs: [, song2, , song4], nested: { job: nestedJob, partner: nestedPartner } } = {
  songs: ["Rainbow Connection", "Moving Right Along", "Never Before, Never Again", "I Hope That Something Better Comes Along"],
  nested: {
